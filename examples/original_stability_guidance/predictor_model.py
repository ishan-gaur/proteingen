...
class ProteinFeatures(nn.Module):
    def __init__(self, edge_features, node_features, num_positional_embeddings=16, num_rbf=16, top_k=30, augment_eps=0.0, num_chain_embeddings=16):
...
class FlowMatchPMPNN(nn.Module):
    def __init__(self, num_letters=21, node_features=128, edge_features=128, hidden_dim=128, num_encoder_layers=4, num_decoder_layers=4, vocab=22, k_neighbors=32, augment_eps=0.1, dropout=0.1):
...
class StabilityPMPNN(nn.Module):
    @classmethod
    def init(cls, num_letters=21, vocab=21, node_features=128, edge_features=128, hidden_dim=128, num_encoder_layers=4, num_decoder_layers=4, k_neighbors=30, dropout=0.0, augment_eps=0.0):
        fm_mpnn = FlowMatchPMPNN(
            node_features=node_features, edge_features=edge_features, hidden_dim=hidden_dim,
            num_encoder_layers=num_encoder_layers, num_decoder_layers=num_decoder_layers,
            k_neighbors=k_neighbors, dropout=dropout, augment_eps=augment_eps,
            vocab=vocab, num_letters=num_letters,
        )
        return cls(fm_mpnn)
...
def load_stability_model(ckpt_path, vocab_size=21, device="cuda", one_hot_encode_input=False):
