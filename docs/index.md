...
Below is we've delineated the main steps of ProteinGuide and which ProteinGen APIs they use. For more conceptual detail on the method, checkout the [ProteinGuide workflow](workflows/protein-guide.md).
